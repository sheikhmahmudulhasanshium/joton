...
export const metadata: Metadata = {
  ...
  // --- CHANGE: Updated site description ---
  ...
  openGraph: {
    ...
    // --- CHANGE: Updated social preview description ---
    description: 'A modern Healthcare Management System for seamless operations.',
    url: siteUrl,
    siteName: 'JOTON',
    images: [
  ...
  twitter: {
    ...
    title: 'JOTON | Healthcare with hope.',
    // --- CHANGE: Updated Twitter card description ---
    description: 'A modern Healthcare Management System for seamless operations.',
  ...
  icons: {
    icon: [
      { media: '(prefers-color-scheme: light)', url: '/svg/symbol-light.svg', type: 'image/svg+xml' },
      { media: '(prefers-color-scheme: dark)', url: '/svg/symbol-dark.svg', type: 'image/svg+xml' },
